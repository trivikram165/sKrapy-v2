...
const VendorDashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-[#FCF9F2] py-5 px-4 font-geist">
            {/* HEADER */}
            <nav className="flex items-center justify-between px-6 py-4 text-gray-700 text-sm">
            ...
            {/* TABLE */}
            <div className="rounded-lg mt-5 flex items-center justify-center overflow-x-auto font-geist">
                <table className="min-w-[1450px] border-collapse bg-white table-auto">
                    <thead>
                        <tr className="bg-[#aadd66] text-center text-sm font-bold text-black">
                            <th className="p-4 px-4 border-r border-2 border-[#F0F0F0] max-w-15"> Order No. </th>
